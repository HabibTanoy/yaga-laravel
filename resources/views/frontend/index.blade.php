...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            ...
            <h1 class="mb-0">{{$choose_data[0]['title']}}</h1>
        </div>
        <div class="row g-5">
            <div class="col-lg-4">
                <div class="row g-5">
                    <div class="col-12 wow zoomIn" data-wow-delay="0.2s">
                        ...
                        <h4>{{$choose_data[0]['tags_one']}}</h4>
                        <p class="mb-0">{{$choose_data[0]['tag_body_one']}}</p>
                    </div>
                    <div class="col-12 wow zoomIn" data-wow-delay="0.6s">
                        <div class="bg-primary rounded d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                            <i class="fa fa-award text-white"></i>
                        </div>
                        <h4>{{$choose_data[0]['tags_two']}}</h4>
                        <p class="mb-0">{{$choose_data[0]['tag_body_two']}}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="row g-5">
                    <div class="col-12 wow zoomIn" data-wow-delay="0.4s">
                        ...
                        <h4>{{$choose_data[0]['tags_three']}}</h4>
                        <p class="mb-0">{{$choose_data[0]['tag_body_three']}}</p>
                    </div>
                    <div class="col-12 wow zoomIn" data-wow-delay="0.8s">
                        <div class="bg-primary rounded d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                            <i class="fa fa-phone-alt text-white"></i>
                        </div>
                        <h4>{{$choose_data[0]['tags_four']}}</h4>
                        <p class="mb-0">{{$choose_data[0]['tag_body_four']}}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="w-100" src="{{URL::asset($employee->image) }}" height="350px" alt="Image">
                        </div>
